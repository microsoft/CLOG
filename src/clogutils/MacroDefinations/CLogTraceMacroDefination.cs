...
namespace clogutils.MacroDefinations
{
    ...
    public class CLogTraceMacroDefination
    {
        ...
        [JsonProperty]
        public virtual int EncodedArgNumber
        {
            get;
            set;
        }
        ...
        [JsonProperty]
        public Dictionary<string, string> MacroConfiguration
        {
            get;
            set;
        }
        ...
        [JsonProperty]
        public Dictionary<string, Dictionary<string, string>> CustomSettings
        {
            get;
            set;
        }
        ...
        [JsonProperty]
        public bool ClassFunctionEncoding
        {
            get;
            set;
        }
